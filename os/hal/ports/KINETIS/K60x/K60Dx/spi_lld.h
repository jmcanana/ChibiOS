 ...
 * @note    The default is @p FALSE.
 */
#if !defined(KINETIS_SPI_USE_SPI2) || defined(__DOXYGEN__)
#define KINETIS_SPI_USE_SPI2                  FALSE
#endif

/**
 * @brief   SPI2 interrupt priority level setting.
 */
#if !defined(KINETIS_SPI_SPI2_IRQ_PRIORITY) || defined(__DOXYGEN__)
...
#if KINETIS_SPI_USE_SPI1 &&                                                   \
    !CORTEX_IS_VALID_KERNEL_PRIORITY(KINETIS_SPI_SPI1_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to SPI1"
#endif

#define KINETIS_HAS_SPI2    TRUE

#if KINETIS_SPI_USE_SPI2 && !KINETIS_HAS_SPI2
...
#if KINETIS_SPI_USE_SPI2 &&                                                   \
    !CORTEX_IS_VALID_KERNEL_PRIORITY(KINETIS_SPI_SPI2_IRQ_PRIORITY)
